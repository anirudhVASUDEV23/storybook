              ...
              >
                ...
                {(title || description) && (
                  <div className="p-4 border-b border-neutral-200 dark:border-neutral-800">
                    {title && (
                      <Heading level="h3" id="modal-title" className="text-xl font-semibold mb-1">
                        {title}
                      </Heading>
                    )}
                    {description && (
                      <Text variant="body" id="modal-description" className="text-neutral-600 dark:text-neutral-400">
                        {description}
                      </Text>
                    )}
                  </div>
...
export const ModalHeader = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { closeButton?: boolean, onClose?: () => void }>(
